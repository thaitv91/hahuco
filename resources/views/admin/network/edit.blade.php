			...
			{{ method_field('PUT') }}
				<div class="box-body">
					...
					<div class="form-group row">
						...
						<div class="col-md-8">
							<select class="selectpicker " id="district_id" name="district_id" title="@lang('admin/network.choose_one')" data-live-search="true" tabindex="-98">
                              <option disabled selected></option>
                              @if(count($district)!=0)
                                  @foreach($district as $db_district)
                                  <option @if($db_district->id == $data['district_id']) selected @endif value="{{$db_district->id}}" data-tokens="{{$db_district->name}}" >{{$db_district->name }} </option>
                                  @endforeach
                               @endif
                              @if(count($district)==0)
                              <option value=""><em>(@lang('admin/network.dont_have'))</em></option>
					...
					<div class="form-group row">
						...
						<div class="col-md-8">
							<input type="text" class="form-control" name="name" id="name" value="{{ $data->name }}" placeholder="@lang('admin/network.enter_name')">
							@if($errors->has('name'))
		                            <span class="help-block">
					...
					<div class="form-group row">
						...
						<div class="col-md-8">
							<input type="text" class="form-control" name="phone" id="phone" value="{{ $data->phone }}" placeholder="@lang('admin/network.enter_phone')">
							@if($errors->has('phone'))
		                            <span class="help-block">
					...
					<div class="form-group row">
						...
						<div class="col-md-8">
							<select class="form-control typeSelect" id="type" name="type">
							    ...
							    <option @if($data->type == 'giaodich') selected @endif value="giaodich">@lang('admin/network.place_transaction')</option>
							    <option @if($data->type == 'chinhanh') selected @endif value="chinhanh">@lang('admin/network.agency')</option>
							    <option @if($data->type == 'gara') selected @endif value="gara">@lang('admin/network.gara')</option>
							    <option @if($data->type == 'benhvien') selected @endif value="benhvien">@lang('admin/network.hospital')</option>
					...
					<div class="form-group row" id="select-scope">
						@if($data->type == 'benhvien')
							<label  class="col-md-2 col-md-offset-1" for="name">@lang('admin/network.scope')</label>
							<div class="col-md-8">
								<select class="form-control typeSelect" id="scope" name="scope">
									<option value="">@lang('admin/network.choose_scope')</option>
								    <option @if($data->scope == "Nội trú") selected @endif value="@lang('admin/network.boarding')">@lang('admin/network.boarding')</option>
								    <option @if($data->scope == "Nội trú - Ngoại trú") selected @endif value="@lang('admin/network.boarding_outpatient')">@lang('admin/network.boarding_outpatient')</option>
								    <option @if($data->scope == "Nội trú - Ngoại trú - Nha khoa") selected @endif value="@lang('admin/network.boarding_outpatient_dentistry')">@lang('admin/network.boarding_outpatient_dentistry')</option>
								    <option @if($data->scope == "Ngoại trú - Nha khoa") selected @endif value="@lang('admin/network.outpatient_dentistry')">@lang('admin/network.outpatient_dentistry')</option>
								    <option @if($data->scope == "Nha Khoa") selected @endif value="@lang('admin/network.dentistry')">@lang('admin/network.dentistry')</option>
								    <option @if($data->scope == "Ngoại trú") selected @endif value="@lang('admin/network.outpatient')">@lang('admin/network.outpatient')</option>
								  </select>
		                    </div>
						@endif
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-8">
		                    <input type="text" class="form-control" id="address" name="address" type="text" size="50" placeholder="@lang('admin/network.enter_address')" autocomplete="on" runat="server" value="{{ $data->address }}" />  
					...
					<div class="form-group row">
						<label  class="col-md-2 col-md-offset-1" for="location">@lang('admin/network.location')</label>
						<div class="col-md-8">
		                    <input type="text" class="form-control" id="location" type="text" size="50" placeholder="@lang('admin/network.enter_location')" autocomplete="on" runat="server" value="{{ $data->address }}" /> 
						</div>
					</div>
					<div class="form-group">
						<label  class="col-md-2 col-md-offset-1"></label>
					...
					<div class="form-group row">
						...
						<div class="col-md-8">
		                    <input type="text" class="form-control" id="cityLat" name="lat" type="text" size="50" placeholder="@lang('admin/network.enter_lat')" value="{{ $data->lat }}"/>  
		                    @if($errors->has('lat'))
		                            <span class="help-block">
					...
					<div class="form-group row">
						...
						<div class="col-md-8">
		                    <input type="text" class="form-control" id="cityLng" name="long" type="text" size="50" placeholder="@lang('admin/network.enter_long')" value="{{ $data->long }}"/>  
		                    @if($errors->has('long'))
		                            <span class="help-block">
				...
				<div class="box-footer">
					<div class="form-group">
						...
						<a href="{{ route('admin.network.index') }}" type="submit" class="btn btn-default">@lang('admin/general.back')</a>
					</div>
				</div>
		</form>
	</div>
