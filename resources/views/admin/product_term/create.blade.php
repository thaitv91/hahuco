...
<div class="col-md-12">	
	...
	<div class="box box-primary">
		...
		<div class="box-header with-border">
			<h3 class="box-title">@lang('admin/term.create_term')</h3>
		</div>
		<!-- /.box-header -->
		<!-- form start -->
			...
			<div class="col-md-8">
				<div class="box-body">
					...
					<div class="form-group margin-bottom-30">
						...
						<textarea type="text" class="form-control" name="excerpt" id="excerpt" rows="5"></textarea>
					...
					<div class="form-group margin-bottom-30">
						...
						<textarea type="text" class="form-control my-editor" name="description" id="description" rows="15"></textarea>
