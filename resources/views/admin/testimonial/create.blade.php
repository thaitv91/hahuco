...
<div class="col-md-12">	
	...
	<div class="box box-primary">
		...
		<div class="box-header with-border">
			<h3 class="box-title">@lang('admin/testimonial.create_testimonial')</h3>
		</div>
		<!-- /.box-header -->
		<!-- form start -->
		<form role="form" id="form-edit" method="POST" enctype="multipart/form-data">
			...
			<div class="col-md-8">
				<div class="box-body">
					...
					<div class="form-group">
						...
						<textarea type="text" class="form-control my-editor" name="content" id="content" rows="15"></textarea>
			...
			<div class="col-md-4">
				<div class="box-body">
					<div class="form-group">
						<label for="content">@lang('admin/testimonial.thumbnail')</label>
