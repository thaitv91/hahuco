			...
			{{ csrf_field() }}
				<div class="box-body">
					...
					<div class="form-group row">
						...
						<div class="col-md-8">
							<input type="text" class="form-control" name="name" id="name" value="{{ old('name') }}" placeholder="@lang('admin/city.enter_name')">
							@if($errors->has('name'))
		                            <span class="help-block">
					...
					<div class="form-group row">
						...
						<div class="col-md-8">
							<input type="text" class="form-control" name="lat" id="lat" value="{{ old('lat') }}" placeholder="@lang('admin/city.enter_lat')">
						@if($errors->has('lat'))
	                            <span class="help-block">
					...
					<div class="form-group row">
						...
						<div class="col-md-8">
							<input type="text" class="form-control" name="long" id="long" value="{{ old('long') }}" placeholder="@lang('admin/city.enter_long')">
						@if($errors->has('long'))
	                            <span class="help-block">
