...
<div class="col-md-12">
	<div class="box box-primary">
		...
		<div class="box-header with-border">
			<h3 class="box-title">@lang('admin/general.create') @lang('admin/recruitment.place')</h3>
		</div>
				...
				<div class="col-md-8">
					<div class="box-body">
						...
						<div class="form-group margin-bottom-30">
							...
							<a href="{{ route('admin.recruitment.place.index') }}" type="submit" class="btn btn-default">@lang('admin/general.back')</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
