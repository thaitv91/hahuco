...
@section('content')
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="form-create" method="POST" action="{{ route('admin.video.store') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="col-md-9">
                    <div class="box-body">
                        ...
                        <div class="form-group margin-bottom-30">
                            ...
                            <input type="text" class="form-control" name="video" id="video" required="required">
                            @if ($errors->has('video'))
                                <span class="help-block">
