...
<div class="col-md-12">	
	...
	<div class="box box-primary">
		...
		<div class="box-header with-border">
			<h3 class="box-title">@lang('admin/award.edit_award')</h3>
		</div>
		<!-- /.box-header -->
		<!-- form start -->
			...
			<div class="col-md-8">
				<div class="box-body">
					<div class="form-group margin-bottom-30">
						...
						<input type="text" class="form-control" name="name" id="name" required="required" value="{{ $award->name }}">
						@if ($errors->has('name'))
					...
					<div class="form-group margin-bottom-30">
						...
						<textarea type="text" class="form-control my-editor" name="tooltip" id="tooltip" rows="10">
							{{ $award->tooltip }}
						</textarea>
			...
			<div class="col-md-4">
				<div class="box-body">
					...
					<div class="form-group margin-bottom-30">
						...
						<img src="{{ asset($award->image) }}" class="img img-thumbnail" id="preview-image" width="675px" height="auto">
					</div>
					<div class="form-group margin-bottom-30">
