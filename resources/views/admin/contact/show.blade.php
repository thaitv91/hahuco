...
<div class="col-md-12">
	<div class="box box-primary">
		<div class="box-header with-border">
			<div class="col-md-12"><h3 class="box-title">@lang('admin/contact.contact')</h3> - <small>@lang('admin/general.detail')</small></div>
		</div>
		<!-- /.box-header -->
		<div class="col-md-12">
			<div class="box-body">
				<div class="row">
					<div class="form-group">
						<label class="label-control col-md-3">@lang('admin/contact.name')</label>
						<p class="label-control col-md-9">{{ $contact->name }}</p>
					</div>
					<div class="form-group">
						<label class="label-control col-md-3">@lang('admin/contact.email')</label>
						<p class="label-control col-md-9">{{ $contact->email }}</p>
					</div>
					<div class="form-group">
						<label class="label-control col-md-3">@lang('admin/contact.phone')</label>
						<p class="label-control col-md-9">{{ $contact->phone }}</p>
					</div>
					<div class="form-group">
						<label class="label-control col-md-3">@lang('admin/contact.content')</label>
		...
		<div class="box-footer">
			<div class="form-group">
				<div class="col-md-12">
					<a href="{{ route('admin.contact') }}" class="btn btn-default">@lang('admin/general.back')</a>
				</div>
			</div>
		</div>
		<!-- /.box-body -->
